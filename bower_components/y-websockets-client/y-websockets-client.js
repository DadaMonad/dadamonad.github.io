 ...
 * @return {Function}
 * @api public
 */module.exports = function(obj,fn){if('string' == typeof fn)fn = obj[fn];if('function' != typeof fn)throw new Error('bind() requires a function');var args=slice.call(arguments,2);return function(){return fn.apply(obj,args.concat(slice.call(arguments)));};};},{}],7:[function(require,module,exports){ /**
 * Expose `Emitter`.
 ...
 * @return {Boolean}
 * @api public
 */Emitter.prototype.hasListeners = function(event){return !!this.listeners(event).length;};},{}],8:[function(require,module,exports){module.exports = function(a,b){var fn=function fn(){};fn.prototype = b.prototype;a.prototype = new fn();a.prototype.constructor = a;};},{}],9:[function(require,module,exports){ /**
...
try{if(window.localStorage)debug.enable(localStorage.debug);}catch(e) {}},{}],10:[function(require,module,exports){module.exports = require('./lib/');},{"./lib/":11}],11:[function(require,module,exports){module.exports = require('./socket'); /**
 * Exports parser
 *
 * @api public
 *
 */module.exports.parser = require('engine.io-parser');},{"./socket":12,"engine.io-parser":23}],12:[function(require,module,exports){(function(global){ /**
 * Module dependencies.
 ...
 * @api private
 *
 */Socket.prototype.filterUpgrades = function(upgrades){var filteredUpgrades=[];for(var i=0,j=upgrades.length;i < j;i++) {if(~index(this.transports,upgrades[i]))filteredUpgrades.push(upgrades[i]);}return filteredUpgrades;};}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"./transport":13,"./transports":14,"component-emitter":7,"debug":20,"engine.io-parser":23,"indexof":28,"parsejson":33,"parseqs":34,"parseuri":22}],13:[function(require,module,exports){ /**
 * Module dependencies.
 ...
 *
 * @api private
 */Transport.prototype.onClose = function(){this.readyState = 'closed';this.emit('close');};},{"component-emitter":7,"engine.io-parser":23}],14:[function(require,module,exports){(function(global){ /**
 * Module dependencies
...
if(query.length){query = '?' + query;}return schema + '://' + this.hostname + port + this.path + query;};},{"../transport":13,"component-inherit":8,"debug":20,"engine.io-parser":23,"parseqs":34,"xmlhttprequest":19}],18:[function(require,module,exports){ /**
 * Module dependencies.
 ...
 * @api public
 */WS.prototype.check = function(){return !!WebSocket && !('__initialize' in WebSocket && this.name === WS.prototype.name);};},{"../transport":13,"component-inherit":8,"debug":20,"engine.io-parser":23,"parseqs":34,"ws":47}],19:[function(require,module,exports){ // browser shim for xmlhttprequest module
...
try{if('undefined' != typeof XDomainRequest && !xscheme && enablesXDR){return new XDomainRequest();}}catch(e) {}if(!xdomain){try{return new ActiveXObject('Microsoft.XMLHTTP');}catch(e) {}}};},{"has-cors":27}],20:[function(require,module,exports){ /**
 ...
 */exports.enable(load());},{"./debug":21}],21:[function(require,module,exports){ /**
 ...
 * @return {Mixed}
 * @api private
 */function coerce(val){if(val instanceof Error)return val.stack || val.message;return val;}},{"ms":31}],22:[function(require,module,exports){ /**
 * Parses an URI
 *
 * @author Steven Levithan <stevenlevithan.com> (MIT license)
 * @api private
 */var re=/^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;var parts=['source','protocol','authority','userInfo','user','password','host','port','relative','path','directory','file','query','anchor'];module.exports = function parseuri(str){var src=str,b=str.indexOf('['),e=str.indexOf(']');if(b != -1 && e != -1){str = str.substring(0,b) + str.substring(b,e).replace(/:/g,';') + str.substring(e,str.length);}var m=re.exec(str || ''),uri={},i=14;while(i--) {uri[parts[i]] = m[i] || '';}if(b != -1 && e != -1){uri.source = src;uri.host = uri.host.substring(1,uri.host.length - 1).replace(/;/g,':');uri.authority = uri.authority.replace('[','').replace(']','').replace(/;/g,':');uri.ipv6uri = true;}return uri;};},{}],23:[function(require,module,exports){(function(global){ /**
 * Module dependencies.
...
var typed=new Uint8Array(msg);msg = '';for(var i=0;i < typed.length;i++) {msg += String.fromCharCode(typed[i]);}}}buffers.push(msg);bufferTail = sliceBuffer(bufferTail,msgLength);}var total=buffers.length;buffers.forEach(function(buffer,i){callback(exports.decodePacket(buffer,binaryType,true),i,total);});};}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"./keys":24,"after":1,"arraybuffer.slice":2,"base64-arraybuffer":4,"blob":5,"has-binary":26,"utf8":46}],24:[function(require,module,exports){ /**
 * Gets the keys for an object.
 *
 * @return {Array} keys
 * @api private
 */module.exports = Object.keys || function keys(obj){var arr=[];var has=Object.prototype.hasOwnProperty;for(var i in obj) {if(has.call(obj,i)){arr.push(i);}}return arr;};},{}],25:[function(require,module,exports){ /**
 * Returns `this`. Execute this without a "context" (i.e. without it being
 * attached to an object of the left-hand side), and `this` points to the
 * "global" scope of the current JS execution.
 */module.exports = (function(){return this;})();},{}],26:[function(require,module,exports){(function(global){ /*
 * Module requirements.
...
if(isLoader){define(function(){return JSON3;});}})(this);},{}],31:[function(require,module,exports){ /**
 * Helpers.
 ...
 */function plural(ms,n,name){if(ms < n)return;if(ms < n * 1.5)return Math.floor(ms / n) + ' ' + name;return Math.ceil(ms / n) + ' ' + name + 's';}},{}],32:[function(require,module,exports){ /**
 * HOP ref.
 ...
 * @return {Boolean}
 * @api public
 */exports.isEmpty = function(obj){return 0 == exports.length(obj);};},{}],33:[function(require,module,exports){(function(global){ /**
 * JSON parse.
 *
 ...
 * @param {String} qs
 * @api private
 */exports.decode = function(qs){var qry={};var pairs=qs.split('&');for(var i=0,l=pairs.length;i < l;i++) {var pair=pairs[i].split('=');qry[decodeURIComponent(pair[0])] = decodeURIComponent(pair[1]);}return qry;};},{}],35:[function(require,module,exports){ /**
 * Parses an URI
 *
 * @author Steven Levithan <stevenlevithan.com> (MIT license)
 * @api private
 */var re=/^(?:(?![^:@]+:[^:@\/]*@)(http|https|ws|wss):\/\/)?((?:(([^:@]*)(?::([^:@]*))?)?@)?((?:[a-f0-9]{0,4}:){2,7}[a-f0-9]{0,4}|[^:\/?#]*)(?::(\d*))?)(((\/(?:[^?#](?![^?#\/]*\.[^?#\/.]+(?:[?#]|$)))*\/?)?([^?#\/]*))(?:\?([^#]*))?(?:#(.*))?)/;var parts=['source','protocol','authority','userInfo','user','password','host','port','relative','path','directory','file','query','anchor'];module.exports = function parseuri(str){var m=re.exec(str || ''),uri={},i=14;while(i--) {uri[parts[i]] = m[i] || '';}return uri;};},{}],36:[function(require,module,exports){module.exports = require('./lib/');},{"./lib/":37}],37:[function(require,module,exports){ /**
 * Module dependencies.
 ...
 *
 * @api public
 */exports.Manager = require('./manager');exports.Socket = require('./socket');},{"./manager":38,"./socket":40,"./url":41,"debug":9,"socket.io-parser":43}],38:[function(require,module,exports){ /**
 * Module dependencies.
 ...
 *
 * @api private
 */Manager.prototype.onreconnect = function(){var attempt=this.backoff.attempts;this.reconnecting = false;this.backoff.reset();this.updateSocketIds();this.emitAll('reconnect',attempt);};},{"./on":39,"./socket":40,"./url":41,"backo2":3,"component-bind":6,"component-emitter":7,"debug":9,"engine.io-client":10,"indexof":28,"object-component":32,"socket.io-parser":43}],39:[function(require,module,exports){ /**
 * Module exports.
 */module.exports = on; /**
 ...
 * @api public
 */function on(obj,ev,fn){obj.on(ev,fn);return {destroy:function destroy(){obj.removeListener(ev,fn);}};}},{}],40:[function(require,module,exports){ /**
 * Module dependencies.
...
this.onclose('io client disconnect');}return this;};},{"./on":39,"component-bind":6,"component-emitter":7,"debug":9,"has-binary":26,"socket.io-parser":43,"to-array":45}],41:[function(require,module,exports){(function(global){ /**
 * Module dependencies.
...
obj.href = obj.protocol + '://' + obj.host + (loc && loc.port == obj.port?'':':' + obj.port);return obj;}}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{"debug":9,"parseuri":35}],42:[function(require,module,exports){(function(global){ /*global Blob,File*/ /**
 * Module requirements
 ...
 *
 * @api private
 */BinaryReconstructor.prototype.finishedReconstruction = function(){this.reconPack = null;this.buffers = [];};function error(data){return {type:exports.ERROR,data:'parser error'};}},{"./binary":42,"./is-buffer":44,"component-emitter":7,"debug":9,"isarray":29,"json3":30}],44:[function(require,module,exports){(function(global){module.exports = isBuf; /**
...
root.utf8 = utf8;}})(this);}).call(this,typeof global !== "undefined"?global:typeof self !== "undefined"?self:typeof window !== "undefined"?window:{});},{}],47:[function(require,module,exports){ /**
 * Module dependencies.
 ...
 * @api public
 */function ws(uri,protocols,opts){var instance;if(protocols){instance = new WebSocket(uri,protocols);}else {instance = new WebSocket(uri);}return instance;}if(WebSocket)ws.prototype = WebSocket.prototype;},{}],48:[function(require,module,exports){ /* global Y */'use strict';var io=require('socket.io-client');function extend(Y){var Connector=(function(_Y$AbstractConnector){_inherits(Connector,_Y$AbstractConnector);function Connector(y,options){_classCallCheck(this,Connector);if(options === undefined){throw new Error('Options must not be undefined!');}if(options.room == null){throw new Error('You must define a room name!');}options.role = 'slave';_Y$AbstractConnector.call(this,y,options);this.options = options;var socket=io(options.url || 'http://localhost:1234');this.socket = socket;var self=this;socket.on('connect',function(){socket.emit('joinRoom',options.room);self.setUserId(socket.id);self.userJoined('server','master');socket.on('yjsEvent',function(message){if(message.type != null){self.receiveMessage('server',message);}});socket.on('disconnect',function(peer){self.userLeft('server');});});}Connector.prototype.disconnect = function disconnect(){this.socket.disconnect();_Y$AbstractConnector.prototype.disconnect.call(this);};Connector.prototype.reconnect = function reconnect(){this.socket.connect();this.socket.emit('joinRoom',this.options.room);this.userJoined('server','master');_Y$AbstractConnector.prototype.reconnect.call(this);};Connector.prototype.send = function send(uid,message){this.socket.emit('yjsEvent',message);};Connector.prototype.broadcast = function broadcast(message){this.socket.emit('yjsEvent',message);};Connector.prototype.isDisconnected = function isDisconnected(){return this.socket.disconnected;};return Connector;})(Y.AbstractConnector);Y.extend('websockets-client',Connector);}module.exports = extend;if(typeof Y !== 'undefined'){extend(Y);}},{"socket.io-client":36}]},{},[48]);