      ...
      Y.requestModules(['Array']).then(function () {
        var YText = (function (_Y$Array$class) {
          ...
          function YText(os, _model, idArray, valArray) {
            ...
            _Y$Array$class.call(this, os, _model, idArray, valArray);
            this.textfields = [];
          }

          YText.prototype.toString = function toString() {
            return this.valArray.join('');
          };

          YText.prototype.insert = function insert(pos, content) {
            _Y$Array$class.prototype.insert.call(this, pos, content.split(''));
          };

          YText.prototype.bind = function bind(textfield, domRoot) {
        ...
        Y.extend('Text', new Y.utils.CustomType({
          ...
          createType: regeneratorRuntime.mark(function YTextCreator() {
            var modelid, model;
            return regeneratorRuntime.wrap(function YTextCreator$(context$4$0) {
              while (1) switch (context$4$0.prev = context$4$0.next) {
                case 0:
                  ...
                  return context$4$0.delegateYield(this.applyCreatedOperations([model]), "t0", 3);

                case 3:
                  return context$4$0.abrupt("return", modelid);
          ...
          initType: regeneratorRuntime.mark(function YTextInitializer(os, model) {
            ...
            return regeneratorRuntime.wrap(function YTextInitializer$(context$4$0) {
              while (1) switch (context$4$0.prev = context$4$0.next) {
                case 0:
                  valArray = [];
                  return context$4$0.delegateYield(Y.Struct.List.map.call(this, model, function (c) {
                    valArray.push(c.content);
                    return JSON.stringify(c.id);
                  }), "t0", 2);

                case 2:
                  idArray = context$4$0.t0;
                  return context$4$0.abrupt("return", new YText(os, model.id, idArray, valArray));
